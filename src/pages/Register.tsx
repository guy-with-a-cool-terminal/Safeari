        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="w-full max-w-lg space-y-8">
              ...
              <CardContent className="pt-10 pb-8 px-6 sm:px-8">
                <div className="text-center space-y-6">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-2xl sm:text-3xl font-semibold text-foreground">Check your email</h2>
                    <p className="text-muted-foreground text-sm sm:text-base">
                      We've sent a verification link to
                    </p>
                    <p className="text-foreground font-medium text-sm sm:text-base break-all px-4">
                      {registeredEmail}
                    </p>
                  </div>

                  {/* Instructions */}
                  <div className="bg-muted/30 rounded-lg p-5 space-y-4 text-left border border-border">
                  ...
                  <div className="space-y-4 pt-2">
                    ...
                    <Link to="/login" className="block">
                      <Button variant="outline" size="lg" className="w-full font-medium hover:bg-muted/50">
                        Back to Sign In
                      </Button>
                    </Link>
                  </div>
            ...
            <p className="text-center text-xs text-muted-foreground">
              Need help?{" "}
              <a href="mailto:support@safeari.co.ke" className="text-primary hover:underline">
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <Card className="border-border bg-card shadow-xl">
            <CardHeader className="space-y-2 pb-6">
              <CardTitle className="text-2xl text-center text-foreground">Start Protecting Your Family</CardTitle>
